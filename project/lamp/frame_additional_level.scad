...
frame_front_additional_level(width, height, frame_width, thickness = thickness, make_3d=make_3d, spacing_2d=1);

module frame_front_additional_level(width, height, frame_width, thickness = thickness, make_3d=make_3d, spacing_2d=1)
{
    hole_radius=[1.5,
                 0,
                 0,
...
module frame_back_additional_level(width, height, frame_width, thickness = thickness, make_3d=make_3d, spacing_2d=1)
{
    hole_radius=[1.5,
                 0,
                 0,
...
module frame_left_additional_level(width, height, frame_width, thickness = thickness, make_3d=make_3d, spacing_2d=1)
{
    hole_radius=[1.5,
                 0,
                 0,
...
module frame_right_additional_level(width, height, frame_width, thickness = thickness, make_3d=make_3d, spacing_2d=1)
{
    hole_radius=[1.5,
                 0,
                 0,
